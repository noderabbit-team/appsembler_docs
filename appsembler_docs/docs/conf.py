# -*- coding: utf-8 -*-
#
# Appsembler Docs documentation build configuration file, created by
...
release = pkg_resources.get_distribution('appsembler').version
...
htmlhelp_basename = 'AppsemblerDocsdoc'
